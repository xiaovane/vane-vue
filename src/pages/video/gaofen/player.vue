            ...
            <section class="container">
                <div class="content-wrap">
                    <div class="content" style="margin-right: unset;">
                        <div class="info-left">
                            <img :src="video.image" :title="video.title">
                        </div>
                        <div class="info-left">
                            <div class="sptitle">
                                <h1>{{video.title}}</h1>
                            ...
                            <div class="am-panel-bd">
                                <div class="bofangdiv">
                                    <img id="addid" src="../../../assets/images/video/1280jiazai.png" style="display: none;width:100%;border: 2px solid #ff6651">
                                       <!-- <iframe id="video"  :src="url" style="width:100%;border:none;" scrolling="no" frameborder="0" allowtransparency="true"
                                                webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>-->
                                    <div id="dplayer">您的浏览器不支持 video 标签</div>
...
<!--                                    <span style="float: right;margin-right: 10px;"><a :href="this.url" target="_self" style="color: #ff7562 !important;">全屏播放>></a></span>-->
                                </div>
